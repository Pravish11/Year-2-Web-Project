<nav>
		...
		<ul>
            ...
            { ?>
                <li><a href="home.php?referer=login"
                <?php
                    if ($active_menu=="home")
                    {
                        echo "class='active'";
			...
			<li><a href="contact.php" 
				...
				<?php
					...
					{ ?>
						...
						</svg><div style="font-size: 16px; display: inline;"> <?php echo $_SESSION['firstname']; ?></div></a>
							<ul style="left:-10px;margin-top: -4px; padding:21px 1px">
