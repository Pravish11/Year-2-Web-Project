<?php 
    ...
    $sql="SELECT b.*,u.firstname,u.lastname,w.name FROM bookings b,user_details u,workout_plans w WHERE b.member_mail=u.email AND status='pending' AND b.workout_id=w.workout_id ORDER BY date,time_range";
